...
function devolverUltimoElemento(array) {
   ...
   var ultimoElemento = array[cantElementos-1];
...
function diaDeLaSemana(numeroDeDia) {
   ...
   } else if (numeroDeDia > 7 || numeroDeDia < 1 || numeroDeDia == undefined) {
      return false;
   } else {
